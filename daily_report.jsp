...
<div class="container">
    <div class="row">
        <table class="table table-hover table-bordered" style="table-layout: fixed;">
            <caption class="text-center"><h3>普惠业务快报</h3></caption>
            <thead>
...
%>
    ...
    <div class="row">
        <table class="table table-hover table-bordered" style="table-layout: fixed;">
            <thead>
             <tr class="alert-success">
                <th class="text-center" style="width:133px;" rowspan="2">事业部</th>
            ...
            <tbody>
<%  ResultSet rs1 = st.executeQuery("SELECT * FROM echart_db.overdue order by fengmu desc");
while(rs1.next()){%>
            <tr class="text-center">
...
function myChart01(){
	...
	option = {
	    ...
	    legend: {
	    	x: 'right',
	        data:['小牛普惠','小微贷事业部','三农贷事业部','农商贷事业部','互联网服务事业部'],
	        selected:{'小微贷事业部':false,'三农贷事业部':false,'农商贷事业部':false,'互联网服务事业部':false},
	        top:'8%'
	    },
	    xAxis:  {
	        type: 'category',
	...
	$.ajax( {
	    url:'GetJson/GJ_curr_month_apply.jsp',
	    type:'post',
	    cache:false,
	    dataType:'json',
...
function myChart02(){
	...
	$.ajax( {
	    url:'GetJson/GJ_curr_month_pass.jsp',
	    type:'post',
	    cache:false,
	    dataType:'json',
	    success:function(result) {
...
function myChart03(){
	...
	$.ajax( {
	    url:'GetJson/GJ_curr_month_loan.jsp',
	    type:'post',
	    cache:false,
	    dataType:'json',
	    success:function(result) {
