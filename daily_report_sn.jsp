...
<div class="container">
    <div class="row">
        <table class="table table-hover table-bordered" style="table-layout: fixed;">
            <caption class="text-center"><h3>三农贷业务快报</h3></caption>
            <thead>
            ...
            <tbody>
<%ResultSet rs = st.executeQuery("SELECT * FROM echart_db.fast_table_sn");  
    while(rs.next()){%>
...
%>
    ...
    <div class="row">
        <table class="table table-hover table-bordered" style="table-layout: fixed;">
            ...
            <tbody>
<%  ResultSet rs1 = st.executeQuery("SELECT * FROM echart_db.overdue_sn order by fengmu desc");
while(rs1.next()){%>
            <tr class="text-center">
...
function myChart01(){
	...
	option = {
	    ...
	    legend: {
	    	x: 'right',
	        data:['三农贷','华南区','华北区','华西区'],
	        selected:{'华南区':false,'华北区':false,'华西区':false},
	        top:'8%'
	    },
	    xAxis:  {
	        type: 'category',
	...
	$.ajax( {
	    url:'GetJson/GJ_curr_month_apply_sn.jsp',
	    type:'post',
	    cache:false,
	    dataType:'json',
...
function myChart02(){
	...
	$.ajax( {
	    url:'GetJson/GJ_curr_month_pass_sn.jsp',
	    type:'post',
	    cache:false,
	    dataType:'json',
	    success:function(result) {
...
function myChart03(){
	...
	$.ajax( {
	    url:'GetJson/GJ_curr_month_loan_sn.jsp',
	    type:'post',
	    cache:false,
	    dataType:'json',
	    success:function(result) {
