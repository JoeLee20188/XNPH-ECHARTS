...
<div class="container">
    <div class="row">
        <table class="table table-hover table-bordered" style="table-layout: fixed;">
            <caption class="text-center"><h3>小微贷业务快报</h3></caption>
            <thead>
            ...
            <tbody>
<%ResultSet rs = st.executeQuery("SELECT * FROM echart_db.fast_table_xw");  
    while(rs.next()){%>
...
%>
    ...
    <div class="row">
        <table class="table table-hover table-bordered" style="table-layout: fixed;">
            ...
            <tbody>
<%  ResultSet rs1 = st.executeQuery("SELECT * FROM echart_db.overdue_xw order by fengmu desc");
while(rs1.next()){%>
            <tr class="text-center">
...
function myChart01(){
	...
	option = {
	    ...
	    legend: {
	    	x: 'right',
	        data:['小微贷','小微一区','小微二区','小微三区','小微四区','小微五区','小微六区',
	              '小微七区','小微八区','小微九区','小微十区','小微十一区'],
	        selected:{'小微一区':false,'小微二区':false,'小微三区':false,'小微四区':false,'小微五区':false,'小微六区':false,
	              '小微七区':false,'小微八区':false,'小微九区':false,'小微十区':false,'小微十一区':false},
	        top:'8%'
	    },
	    xAxis:  {
	        type: 'category',
	...
	$.ajax( {
	    url:'GetJson/GJ_curr_month_apply_xw.jsp',
	    type:'post',
	    cache:false,
	    dataType:'json',
	        ...
	        myChart01.setOption(
	                {
	                    ...
	                    series: [
	                        ...
	                        {data:result.apply_num3},
	                        {data:result.apply_num4},
	                        {data:result.apply_num5},
	                        {data:result.apply_num6},
	                        {data:result.apply_num7},
	                        {data:result.apply_num8},
	                        {data:result.apply_num9},
	                        {data:result.apply_num10},
	                        {data:result.apply_num11}
	                    ]
	                });
	    },
	    error : function() {
...
function myChart02(){
	...
	$.ajax( {
	    url:'GetJson/GJ_curr_month_pass_xw.jsp',
	    type:'post',
	    cache:false,
	    dataType:'json',
	    success:function(result) {
	        ...
	        myChart02.setOption(
	                {
	                    ...
	                    series: [
	 	                        ...
	 	                        {data:result.pass_num3},
	 	                        {data:result.pass_num4},
	 	                        {data:result.pass_num5},
	 	                        {data:result.pass_num6},
	 	                        {data:result.pass_num7},
	 	                        {data:result.pass_num8},
	 	                        {data:result.pass_num9},
	 	                        {data:result.pass_num10},
	 	                        {data:result.pass_num11}
	                    ]
	                });
	    },
	    error : function() {
...
function myChart03(){
	...
	$.ajax( {
	    url:'GetJson/GJ_curr_month_loan_xw.jsp',
	    type:'post',
	    cache:false,
	    dataType:'json',
	    success:function(result) {
	        ...
	        myChart03.setOption(
	                {
	                    ...
	                    series: [
	    	 	                        ...
	    	 	                        {data:result.loan_money3},
	    	 	                        {data:result.loan_money4},
	    	 	                        {data:result.loan_money5},
	    	 	                        {data:result.loan_money6},
	    	 	                        {data:result.loan_money7},
	    	 	                        {data:result.loan_money8},
	    	 	                        {data:result.loan_money9},
	    	 	                        {data:result.loan_money10},
	    	 	                        {data:result.loan_money11}
	                    ]
	                });
	    },
	    error : function() {
