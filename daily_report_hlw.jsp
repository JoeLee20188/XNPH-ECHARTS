...
<div class="container">
    <div class="row">
        <table class="table table-hover table-bordered" style="table-layout: fixed;">
            <caption class="text-center"><h3>互联网业务快报</h3></caption>
            <thead>
            <tr class="alert-success">
                <th class="text-center" style="width:140px;">区域</th>
            ...
            <tbody>
<%ResultSet rs = st.executeQuery("SELECT * FROM echart_db.fast_table_hlw");  
    while(rs.next()){%>
...
%>
    ...
    <div class="row">
        <table class="table table-hover table-bordered" style="table-layout: fixed;">
            ...
            <tbody>
<%  ResultSet rs1 = st.executeQuery("SELECT * FROM echart_db.overdue_hlw order by fengmu desc");
while(rs1.next()){%>
            <tr class="text-center">
...
function myChart01(){
	...
	$.ajax( {
	    url:'GetJson/GJ_curr_month_apply_hlw.jsp',
	    type:'post',
	    cache:false,
	    dataType:'json',
...
function myChart02(){
	...
	$.ajax( {
	    url:'GetJson/GJ_curr_month_pass_hlw.jsp',
	    type:'post',
	    cache:false,
	    dataType:'json',
	    success:function(result) {
...
function myChart03(){
	...
	$.ajax( {
	    url:'GetJson/GJ_curr_month_loan_hlw.jsp',
	    type:'post',
	    cache:false,
	    dataType:'json',
	    success:function(result) {
